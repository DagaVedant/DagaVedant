...
Aspiring software engineer constantly building, learning, and shipping.
I work across AI/ML, full-stack web dev, and automation and i'm picking up new
languages and frameworks as I go.

## Projects I've Built
- **[VoiceGPT](https://github.com/DagaVedant/VoiceGPT)** — Voice-controlled GPT-4o assistant + DALL·E 3 image generator *(Maker Fair 2024)*
- **[Spam-Message-AI-Classifier](https://github.com/DagaVedant/Spam-Message-AI-Classifier)** — NLP spam detector using Naive Bayes, trained from scratch
...
- Training and fine-tuning my own ML models
- Expanding across Python, TypeScript, JavaScript, and more
